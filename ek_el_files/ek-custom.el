(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (wttrin git-gutter-fringe suggest ox-latex yasnippet ls-lisp flycheck-pyflakes flycheck markdown-mode rainbow-delimiters-mode t rainbow-delimiters iedit ido-occur company-quickhelp company-flx magit use-package))))
(custom-set-faces
